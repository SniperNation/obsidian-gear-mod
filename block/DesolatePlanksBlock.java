...
@Tag
public class DesolatePlanksBlock extends ObsidianGearModElements.ModElement
{
    @ObjectHolder("obsidian_gear:desolate_planks")
    public static final Block block;
    
    public DesolatePlanksBlock(final ObsidianGearModElements instance) {
        super(instance, 64);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(DesolatePlanksBlock.block, new Item.Properties().func_200916_a(ObsidianGearItemGroup.tab));
            return (Item)blockItem.setRegistryName(DesolatePlanksBlock.block.getRegistryName());
        });
    }
    ...
    {
        public CustomBlock() {
            super(AbstractBlock.Properties.func_200945_a(Material.field_151575_d).func_200947_a(SoundType.field_185848_a).func_200948_a(2.0f, 3.0f).func_235838_a_(s -> 0).harvestLevel(0).harvestTool(ToolType.AXE).func_235861_h_());
            this.setRegistryName("desolate_planks");
        }
