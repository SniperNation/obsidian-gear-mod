...
public class DesolateStairsBlock extends ObsidianGearModElements.ModElement
{
    ...
    public DesolateStairsBlock(final ObsidianGearModElements instance) {
        super(instance, 66);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(DesolateStairsBlock.block, new Item.Properties().func_200916_a(ObsidianGearItemGroup.tab));
            return (Item)blockItem.setRegistryName(DesolateStairsBlock.block.getRegistryName());
        });
    }
    ...
    {
        public CustomBlock() {
            super(() -> new Block(AbstractBlock.Properties.func_200945_a(Material.field_151575_d).func_200947_a(SoundType.field_185848_a).func_200948_a(3.0f, 2.0f).func_235838_a_(s -> 0)).func_176223_P(), AbstractBlock.Properties.func_200945_a(Material.field_151575_d).func_200947_a(SoundType.field_185848_a).func_200948_a(3.0f, 2.0f).func_235838_a_(s -> 0));
            this.setRegistryName("desolate_stairs");
        }
