...
public class EnderiteOreFeature extends OreFeature {
	public static final EnderiteOreFeature FEATURE = (EnderiteOreFeature) new EnderiteOreFeature().setRegistryName("obsidian_gear:enderite_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(EnderiteOreFeatureRuleTest.INSTANCE, ObsidianGearModBlocks.ENDERITE_ORE.defaultBlockState(), 1))
	...
	private static class EnderiteOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<EnderiteOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("obsidian_gear:enderite_ore_match"), () -> codec);
