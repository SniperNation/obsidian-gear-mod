...
public class DesolatePlainsLeaveDecorator extends LeaveVineDecorator {
	public static final DesolatePlainsLeaveDecorator INSTANCE = new DesolatePlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("desolate_plains_tree_leave_decorator");
