...
public class SpookForestLeaveDecorator extends LeaveVineDecorator {
	public static final SpookForestLeaveDecorator INSTANCE = new SpookForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("spook_forest_tree_leave_decorator");
