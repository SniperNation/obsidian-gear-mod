...
public class WitherStatueFeature extends Feature<NoneFeatureConfiguration> {
	public static final WitherStatueFeature FEATURE = (WitherStatueFeature) new WitherStatueFeature().setRegistryName("obsidian_gear:wither_statue");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public WitherStatueFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("obsidian_gear", "wither"));
		if (template == null)
			return false;
