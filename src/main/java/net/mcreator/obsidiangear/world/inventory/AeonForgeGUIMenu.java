...
public class AeonForgeGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AeonForgeGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ObsidianGearModMenus.AEON_FORGE_GUI, id);
