...
public class DecayedForestBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(
						new SimpleStateProvider(ObsidianGearModBlocks.DECAYED_LOG.defaultBlockState()), new StraightTrunkPlacer(7, 2, 0),
						new SimpleStateProvider(ObsidianGearModBlocks.DECAYED_LEAVES.defaultBlockState()),
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(ObsidianGearMod.MODID, "decayed_forest"),
				SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(ObsidianGearMod.MODID, name + "_decayed_forest"), configuredFeature);
