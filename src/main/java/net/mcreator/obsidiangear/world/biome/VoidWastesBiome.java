...
public class VoidWastesBiome extends ObsidianGearModElements.ModElement {
	...
	public VoidWastesBiome(ObsidianGearModElements instance) {
		super(instance, 13);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13434778).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-13434778).withFoliageColor(10387789).withGrassColor(9470285).build();
				...
				event.getRegistry().register(biome.setRegistryName("obsidian_gear:void_wastes"));
			}
		}
	}
	@Override
