...
public class PoisonTouchEnchantment extends ObsidianGearModElements.ModElement {
	...
	public PoisonTouchEnchantment(ObsidianGearModElements instance) {
		super(instance, 92);
	}

	@Override
	public void initElements() {
		elements.enchantments.add(() -> new CustomEnchantment(EquipmentSlotType.MAINHAND).setRegistryName("poison_touch"));
	}
