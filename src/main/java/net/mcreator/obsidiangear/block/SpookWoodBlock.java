...
public class SpookWoodBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_wood")
	public static final Block block = null;
	public SpookWoodBlock(ObsidianGearModElements instance) {
		super(instance, 129);
	}
