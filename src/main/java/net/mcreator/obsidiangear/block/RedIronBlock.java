...
public class RedIronBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:red_iron")
	public static final Block block = null;
	public RedIronBlock(ObsidianGearModElements instance) {
		super(instance, 103);
	}
