...
public class SpookFenceBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_fence")
	public static final Block block = null;
	public SpookFenceBlock(ObsidianGearModElements instance) {
		super(instance, 135);
	}
