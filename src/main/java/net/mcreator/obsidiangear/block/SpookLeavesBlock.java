...
public class SpookLeavesBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_leaves")
	public static final Block block = null;
	public SpookLeavesBlock(ObsidianGearModElements instance) {
		super(instance, 132);
	}
