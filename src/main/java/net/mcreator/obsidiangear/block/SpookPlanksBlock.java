...
public class SpookPlanksBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_planks")
	public static final Block block = null;
	public SpookPlanksBlock(ObsidianGearModElements instance) {
		super(instance, 131);
	}
