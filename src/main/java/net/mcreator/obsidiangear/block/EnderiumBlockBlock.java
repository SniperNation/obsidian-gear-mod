...
public class EnderiumBlockBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:enderium_block")
	public static final Block block = null;
	public EnderiumBlockBlock(ObsidianGearModElements instance) {
		super(instance, 107);
	}
