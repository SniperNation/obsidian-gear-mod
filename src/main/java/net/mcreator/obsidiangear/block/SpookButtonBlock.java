...
public class SpookButtonBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_button")
	public static final Block block = null;
	public SpookButtonBlock(ObsidianGearModElements instance) {
		super(instance, 138);
	}
