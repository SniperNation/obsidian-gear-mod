...
public class SpookPressurePlateBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_pressure_plate")
	public static final Block block = null;
	public SpookPressurePlateBlock(ObsidianGearModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("spook_pressure_plate");
		}
