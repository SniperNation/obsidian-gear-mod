...
public class SpookLogBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_log")
	public static final Block block = null;
	public SpookLogBlock(ObsidianGearModElements instance) {
		super(instance, 130);
	}
