...
public class AeonForgeBlockBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:aeon_forge_block")
	public static final Block block = null;
	@ObjectHolder("obsidian_gear:aeon_forge_block")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public AeonForgeBlockBlock(ObsidianGearModElements instance) {
		super(instance, 100);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("aeon_forge_block"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aeon_forge_block");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This is an advanced crafting table!"));
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("aeon_forge_block");
		}
