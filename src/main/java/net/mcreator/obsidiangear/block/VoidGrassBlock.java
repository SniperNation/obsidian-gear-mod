...
public class VoidGrassBlock extends ObsidianGearModElements.ModElement {
	...
	public VoidGrassBlock(ObsidianGearModElements instance) {
		super(instance, 17);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("obsidian_gear:void_grass_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("void_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("obsidian_gear:void_grass"), configuredFeature);
		}
	}
	@SubscribeEvent
