...
public class DesolateLogBlock extends ObsidianGearModElements.ModElement {
	...
	public DesolateLogBlock(ObsidianGearModElements instance) {
		super(instance, 63);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("obsidian_gear:desolate_log_match"),
			...
			event.getRegistry().register(feature.setRegistryName("desolate_log"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("obsidian_gear:desolate_log"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("obsidian_gear:desolate_plains").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
