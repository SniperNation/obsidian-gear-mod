...
public class DesolateLeavesBlock extends ObsidianGearModElements.ModElement {
	...
	public DesolateLeavesBlock(ObsidianGearModElements instance) {
		super(instance, 65);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("desolate_leaves");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("obsidian_gear:desolate_leaves_match"),
			...
			event.getRegistry().register(feature.setRegistryName("desolate_leaves"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("obsidian_gear:desolate_leaves"), configuredFeature);
		}
	}
	@SubscribeEvent
