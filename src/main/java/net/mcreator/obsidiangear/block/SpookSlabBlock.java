...
public class SpookSlabBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_slab")
	public static final Block block = null;
	public SpookSlabBlock(ObsidianGearModElements instance) {
		super(instance, 134);
	}
