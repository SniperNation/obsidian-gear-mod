...
public class EnderiumOreBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:enderium_ore")
	public static final Block block = null;
	public EnderiumOreBlock(ObsidianGearModElements instance) {
		super(instance, 106);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnderiumIngotItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("obsidian_gear:enderium_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("obsidian_gear:enderium_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
