...
public class SpookStairsBlock extends ObsidianGearModElements.ModElement {
	@ObjectHolder("obsidian_gear:spook_stairs")
	public static final Block block = null;
	public SpookStairsBlock(ObsidianGearModElements instance) {
		super(instance, 133);
	}
