...
import net.mcreator.obsidiangear.item.UpgradeGemItem;
import net.mcreator.obsidiangear.item.UpgradeGem3Item;
import net.mcreator.obsidiangear.item.UpgradeGem2Item;
...
import net.mcreator.obsidiangear.item.ReinforcedEventideLvl3Item;
import net.mcreator.obsidiangear.item.ReinforcedEventideLvl2Item;
import net.mcreator.obsidiangear.item.ReinforcedEventideItem;
...
import net.mcreator.obsidiangear.item.EventideItem;
...
import net.mcreator.obsidiangear.item.DragonboneItemItem;
...
public class ObsidianGearModItems {
	...
	public static final Item EVENTIDE = register(new EventideItem());
	public static final Item DRAGONBONE_ITEM = register(new DragonboneItemItem());
	public static final Item REINFORCED_EVENTIDE = register(new ReinforcedEventideItem());
	public static final Item REINFORCED_EVENTIDE_LVL_2 = register(new ReinforcedEventideLvl2Item());
	public static final Item REINFORCED_EVENTIDE_LVL_3 = register(new ReinforcedEventideLvl3Item());
	public static final Item UPGRADE_GEM = register(new UpgradeGemItem());
	public static final Item UPGRADE_GEM_2 = register(new UpgradeGem2Item());
	public static final Item UPGRADE_GEM_3 = register(new UpgradeGem3Item());
