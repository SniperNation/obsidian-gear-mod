...
public class KyriteBlockBlock extends ObsidianGearModElements.ModElement
{
    ...
    public KyriteBlockBlock(final ObsidianGearModElements instance) {
        super(instance, 22);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(KyriteBlockBlock.block, new Item.Properties().func_200916_a(ObsidianGearItemGroup.tab));
            return (Item)blockItem.setRegistryName(KyriteBlockBlock.block.getRegistryName());
        });
    }
    ...
    {
        public CustomBlock() {
            super(AbstractBlock.Properties.func_200945_a(Material.field_151573_f).func_200947_a(SoundType.field_185852_e).func_200948_a(5.0f, 10.0f).func_235838_a_(s -> 0).harvestLevel(5).harvestTool(ToolType.PICKAXE).func_235861_h_());
            this.setRegistryName("kyrite_block");
        }
