...
@Tag
public class DesolateFenceGateBlock extends ObsidianGearModElements.ModElement
{
    @ObjectHolder("obsidian_gear:desolate_fence_gate")
    public static final Block block;
    
    public DesolateFenceGateBlock(final ObsidianGearModElements instance) {
        super(instance, 69);
    }
    ...
    public void initElements() {
        ...
        this.elements.items.add(() -> {
            new BlockItem(DesolateFenceGateBlock.block, new Item.Properties().func_200916_a(ItemGroup.field_78028_d));
            return (Item)blockItem.setRegistryName(DesolateFenceGateBlock.block.getRegistryName());
        });
    }
    ...
    public static class CustomBlock extends FenceGateBlock
    {
        public CustomBlock() {
            ...
            this.setRegistryName("desolate_fence_gate");
        }
