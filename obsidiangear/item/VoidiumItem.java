...
@Tag
public class VoidiumItem extends ObsidianGearModElements.ModElement
{
    @ObjectHolder("obsidian_gear:voidium")
    public static final Item block;
    
    public VoidiumItem(final ObsidianGearModElements instance) {
        super(instance, 41);
    }
