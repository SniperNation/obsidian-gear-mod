...
import net.mcreator.obsidiangear.procedures.TpOverworldCommandExecutedProcedure;
...
public class TpOverworldCommand
{
    @SubscribeEvent
    public static void registerCommands(final RegisterCommandsEvent event) {
        event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)LiteralArgumentBuilder.literal("tpoverworld").requires(s -> s.func_197034_c(4))).then(Commands.func_197056_a("arguments", (ArgumentType)StringArgumentType.greedyString()).executes(TpOverworldCommand::execute))).executes(TpOverworldCommand::execute));
    }
    ...
    private static int execute(final CommandContext<CommandSource> ctx) {
        ...
        TpOverworldCommandExecutedProcedure.executeProcedure($_dependencies);
        return 0;
    }
}
