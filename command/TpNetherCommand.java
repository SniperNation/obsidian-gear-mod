...
import net.mcreator.obsidiangear.procedures.TpNetherCommandExecutedProcedure;
...
public class TpNetherCommand
{
    @SubscribeEvent
    public static void registerCommands(final RegisterCommandsEvent event) {
        event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)LiteralArgumentBuilder.literal("tpnether").requires(s -> s.func_197034_c(4))).then(Commands.func_197056_a("arguments", (ArgumentType)StringArgumentType.greedyString()).executes(TpNetherCommand::execute))).executes(TpNetherCommand::execute));
    }
    ...
    private static int execute(final CommandContext<CommandSource> ctx) {
        ...
        TpNetherCommandExecutedProcedure.executeProcedure($_dependencies);
        return 0;
    }
}
