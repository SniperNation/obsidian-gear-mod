...
public class TpEndCommand
{
    ...
    public static void registerCommands(final RegisterCommandsEvent event) {
        event.getDispatcher().register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)LiteralArgumentBuilder.literal("tpend").requires(s -> s.func_197034_c(4))).then(Commands.func_197056_a("arguments", (ArgumentType)StringArgumentType.greedyString()).executes(TpEndCommand::execute))).executes(TpEndCommand::execute));
    }
