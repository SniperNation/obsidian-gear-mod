...
public class TpNetherCommandExecutedProcedure
{
    public static void executeProcedure(final Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            if (!dependencies.containsKey("entity")) {
                ObsidianGearMod.LOGGER.warn("Failed to load dependency entity for procedure TpNetherCommandExecuted!");
            }
            return;
        }
        final Entity _ent;
        ...
        if (!_ent.field_70170_p.field_72995_K && _ent instanceof ServerPlayerEntity) {
            final RegistryKey<World> destinationType = (RegistryKey<World>)World.field_234919_h_;
