...
public class TpVoidCommandExecutedProcedure
{
    public static void executeProcedure(final Map<String, Object> dependencies) {
        if (dependencies.get("entity") == null) {
            if (!dependencies.containsKey("entity")) {
                ObsidianGearMod.LOGGER.warn("Failed to load dependency entity for procedure TpVoidCommandExecuted!");
            }
            return;
        }
        final Entity _ent;
        ...
        if (!_ent.field_70170_p.field_72995_K && _ent instanceof ServerPlayerEntity) {
            final RegistryKey<World> destinationType = (RegistryKey<World>)RegistryKey.func_240903_a_(Registry.field_239699_ae_, new ResourceLocation("obsidian_gear:the_void"));
